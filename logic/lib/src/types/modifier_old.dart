...
@immutable
class ModifierOld {
  const ModifierOld({this.percent = 0.0, this.flat = 0.0});
  ...
  ModifierOld combine(ModifierOld other) {
    return ModifierOld(
  ...
  static ModifierOld combineAll(Iterable<ModifierOld> modifiers) {
    var result = const ModifierOld();
